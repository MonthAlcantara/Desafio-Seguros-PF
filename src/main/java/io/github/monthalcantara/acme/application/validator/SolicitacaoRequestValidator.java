package io.github.monthalcantara.acme.application.validator;
...
public class SolicitacaoRequestValidator {
    ...
    public void validar(SolicitacaoRequest dto) {
    ...
    private void validar(String nomeCampo, String valor, Predicate<String> validador, List<String> erros) {
