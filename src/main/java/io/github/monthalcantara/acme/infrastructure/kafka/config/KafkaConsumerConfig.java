package io.github.monthalcantara.acme.infrastructure.kafka.config;
...
public class KafkaConsumerConfig {
    ...
    public ConcurrentKafkaListenerContainerFactory<String, PaymentEvent> paymentKafkaListenerContainerFactory() {
        ...
        factory.setConsumerFactory(new DefaultKafkaConsumerFactory<>(consumerProps(PaymentEvent.class)));
        return factory;
    }
    ...
    public ConcurrentKafkaListenerContainerFactory<String, SubscriptionEvent> subscriptionKafkaListenerContainerFactory() {
        ...
        factory.setConsumerFactory(new DefaultKafkaConsumerFactory<>(consumerProps(SubscriptionEvent.class)));
        return factory;
    }

    private Map<String, Object> consumerProps(Class<?> clazz) {
        Map<String, Object> props = new HashMap<>();
        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, bootstrapServers);
        props.put(ConsumerConfig.GROUP_ID_CONFIG, GROUP_ID);
        props.put(ConsumerConfig.AUTO_OFFSET_RESET_CONFIG, "earliest");
